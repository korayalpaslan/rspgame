...
function selectingYourPick(e){
    ...
    document.querySelector('#paper-icon').style.pointerEvents = 'none';
    document.querySelector('#scissors').style.pointerEvents = 'none';
    document.querySelector('#scissors-icon').style.pointerEvents = 'none';
...
function resetGame(){
    ...
    document.querySelector('#paper').style.pointerEvents = 'auto';
    document.querySelector('#paper-icon').style.pointerEvents = 'auto';
    document.querySelector('#scissors').style.pointerEvents = 'auto';
    document.querySelector('#scissors-icon').style.pointerEvents = 'auto';
}